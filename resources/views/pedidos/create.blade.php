...
<!-- Formulario de Insumo-->  
    ...
    <br/><br/>    
      ...
      {!! Form::select ('referencia', $proveedores->pluck('direccion', 'id')->all(),null,['placeholder'=>'--Selecciona una referencia --', 'class'=>'col-75 esqrs', 'required']) !!}   
    <br/><br/>    
      {!! Form::label ('iva',' Cantidad de insumos', ['class'=>'control-label col-25 glyphicon glyphicon-plus-sign'])!!}
      {!! Form::text ('iva',null,['placeholder'=>'Ingresa cantidad de insumos', 'class'=>'esqr col-75', 'required', 'maxlength'=>'100'])!!}
    <br/><br/><br/>    
      {!! Form::label ('subtotal',' Precio Costo', ['class'=>'control-label col-25 glyphicon glyphicon-usd'])!!}
      {!! Form::text ('subtotal',null,['placeholder'=>'$500.00', 'class'=>'esqr col-75', 'required', 'maxlength'=>'30'])!!}
    <br/><br/><br/>
    <!-- ESTE SE DEBE CALCULAR A PARTIR DEL Precio-->    
      {!! Form::label ('total',' Total', ['class'=>'control-label col-25 glyphicon glyphicon-usd'])!!}
      {!! Form::text ('total',null,['placeholder'=>'$1000.00', 'class'=>'esqr col-75', 'required', 'maxlength'=>'30'])!!} 
    <br/><br/><br/>   
