...
@section('contenido_categorias')
  <!-- Formulario de Tipo de Producto-->  
    ...
    <h2>Registro de Tipos de Productos</h2>   
    <br/> 
    {!! Form::open(['url'=>'/categorias'])!!}    
      {!! Form::label ('tipo_producto',' Tipo de Producto', ['class'=>'control-label col-25 glyphicon glyphicon-lamp'])!!}
      {!! Form::text ('tipo_producto',null,['placeholder'=>'Ingresa nombre del tipo de producto', 'class'=>'esqr col-75', 'required', 'maxlength'=>'30'])!!}   
    <br/><br/><br/>    
      {!! Form::label ('descripcion',' Descripción', ['class'=>'control-label col-25 glyphicon glyphicon-list-alt'])!!}
      {!! Form::text ('descripcion',null,['placeholder'=>'Ingresa una breve descripción', 'class'=>'esqr col-75', 'required', 'maxlength'=>'150'])!!}   
    <br/><br/><br/>    
