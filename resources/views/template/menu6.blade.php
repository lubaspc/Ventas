  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li><a href="{!! asset('proveedores') !!}"><span class="glyphicon glyphicon-user"></span> Proveedores</a></li> 
        <li><a href="{!! asset('insumos') !!}"><span class="glyphicon glyphicon-lamp"></span> Insumos</a></li>        
      </ul> 
