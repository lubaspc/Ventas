 ...
 <!-- REGISTRO DE Bancos -->  
  <div class="container" id="registro_formulario" style="display: block; width: 800px; height: auto; background-color: #D3CEBE;">  
    ...
    {!! Form::open(['url'=>'/bancos'])!!}          
      ...
      {!! Form::text ('nombre_banco',null,['placeholder'=>'Ingresa nombre del banco', 'class'=>'esqr col-75', 'required', 'maxlength'=>'30'])!!}           
      <br/><br/><br/>
        {!! Form::label ('telefono',' Teléfono', ['class'=>'control-label col-25 glyphicon glyphicon-phone-alt'])!!}
        {!! Form::text ('telefono',null,['placeholder'=>'+52 7225894110', 'class'=>'esqr col-75', 'required', 'maxlength'=>'10'])!!}  
      <br/><br/><br/>      
    ...
    <div style="text-align: center;">
      <button class="btn btn-success" type="reset" onclick="avisoreset()">
