...
<!-- Formulario de cta_bancaria-->  
    ...
    <h2>Registro de cta bancarias</h2> 
    <br/> 
    {!! Form::open(['url'=>'/cta_bancarias'])!!}    
    ...
    <br/>     <br/> 
      ...
      {!! Form::select ('id_bancos', $bancos->pluck('nombre_banco', 'id')->all(),null,['placeholder'=>'--Selecciona un banco--', 'class'=>'col-75 esqrs', 'required']) !!}  
    <br/>  <br/>    
      {!! Form::label ('tipo_cuenta',' Tipo de Cta Bancaria', ['class'=>'control-label col-25 glyphicon glyphicon-credit-card'])!!}
      {!! Form::select ('tipo_cuenta', array('Debito'=>'Debito', 'Credito'=>'Credito'),null,['placeholder'=>'--Selecciona tipo de cta--', 'class'=>'col-75 esqrs', 'required']) !!}   
    <br/>  <br/>   
      {!! Form::label ('numero_cuenta',' Número de Cuenta', ['class'=>'control-label col-25 glyphicon glyphicon-credit-card'])!!}
      {!! Form::text ('numero_cuenta',null,['placeholder'=>'Ingresa número de cuenta', 'class'=>'esqr col-75', 'required', 'maxlength'=>'16'])!!}   
    <br/>  <br/> <br/>   
