...
<!-- Formulario de Tipo de Pagos-->  
    ...
    <h2>Editar Tipos de Pago</h2>  <br/>  
    {!! Form::open([ 'method' => 'PATCH', 'url'=>'/tipo_pagos/'.$tipo_pagos->id]) !!}
    {!! Form::label ('categoria',' Tipo de Pago', ['class'=>'control-label col-25 glyphicon glyphicon-usd'])!!}
      {!! Form::text ('categoria',$tipo_pagos->categoria,['placeholder'=>'Ingresa nombre del tipo de pago', 'class'=>'esqr col-75', 'required', 'maxlength'=>'30'])!!}   
    <br/><br/><br/>    
