...
<!-- Formulario de Insumo-->  
    ...
    <h2>Editar Insumos</h2> <br/>
    {!! Form::open(['method' => 'PATCH', 'url'=>'/insumos/'.$insumos->id]) !!}
    {!! Form::label ('nombre_insumo',' Nombre del Insumo', ['class'=>'control-label col-25 glyphicon glyphicon-lamp'])!!}
      {!! Form::text ('nombre_insumo',$insumos->nombre_insumo,['placeholder'=>'Ingresa nombre del insumo', 'class'=>'esqr col-75', 'required', 'maxlength'=>'100'])!!}   
    <br/><br/><br/>    
      {!! Form::label ('detalles',' Detalles', ['class'=>'control-label col-25 glyphicon glyphicon-list-alt'])!!}
      {!! Form::text ('detalles',$insumos->detalles,['placeholder'=>'Ingresa detalles', 'class'=>'esqr col-75', 'required', 'maxlength'=>'250'])!!}   
    <br/><br/><br/>    
      {!! Form::label ('id_proveedores',' Proveedor', ['class'=>'control-label col-25 glyphicon glyphicon-list-alt'])!!}
      {!! Form::select ('id_proveedores', $proveedores->pluck('nombre_prov', 'id')->all(),$insumos->id_proveedores,['placeholder'=>'--Selecciona un proveedor--', 'class'=>'col-75 esqrs', 'required']) !!}  
    <br/><br/>    
